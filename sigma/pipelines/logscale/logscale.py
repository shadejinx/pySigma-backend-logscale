...
@Pipeline
def logscale_pipeline() -> ProcessingPipeline:        # Processing pipelines should be defined as functions that return a ProcessingPipeline object.
    return ProcessingPipeline(
        name="lql example pipeline",
        ...
        items=[
            ProcessingItem(     # This is an example for processing items generated from the mapping above.
                identifier=f"logscale_windows_{service}",
            ...
            ProcessingItem(     # Field mappings
                identifier="logscale_field_mapping",
