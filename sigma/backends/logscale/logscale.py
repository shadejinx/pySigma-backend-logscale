...
#from sigma.pipelines.logscale import # TODO: add pipeline imports or delete this line
import sigma
import re
...
class logscaleBackend(TextQueryBackend):
    ...
    re_flags : Dict[SigmaRegularExpressionFlag, str] = {
        ...
        SigmaRegularExpressionFlag.DOTALL    : "d",
    }
    ...
    field_equals_field_expression : ClassVar[Optional[str]] = "test({field1} == {field2})"  # Field comparison expression with the placeholders {field1} and {field2} corresponding to left field and right value side of Sigma detection item
